    ...
    <>
        <div className="intro__wrapper">
            ...
            <p className='text'>Hello, My name is Yida (August) Wang. 
                I am currently a junior studying computer science at Boston University.</p>
            </div>
            <div className='recent_news'>
            <p className='title'>Recent News</p>
            <p className='text'>In November, I will be participating in SC22 with the Boston University and Northeastern University student cluster team in person in Dallas, TX</p>
